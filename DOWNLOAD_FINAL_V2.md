# OCR Card Recognizer v2.1.5（最终优化版）- 下载指南
...
```
https://coze-coding-project.tos.coze.site/coze_storage_7602859016070627343/ocr-card-recognizer-windows-v2.1.5.tar_46502896.gz?sign=1772860849-4812722da7-0-f6050c7fec6e7fc50e05862104250cda598e5fc0002053f431ded05f0ab41054
```
...
- `docs/LOG_OPTIMIZATION.md` - 日志优化说明
- `VERSION.txt` - 版本信息
