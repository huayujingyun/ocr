...
# OCR Card Recognizer - Windows Deployment Package v2.1.3
...
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}  OCR Card Recognizer - Packaging v2.1.3${NC}"
echo -e "${GREEN}========================================${NC}"
echo ""

# Package info
PACKAGE_NAME="ocr-card-recognizer-windows-v2.1.3"
PACKAGE_VERSION="v2.1.3"
...
- v${PACKAGE_VERSION} (${PACKAGE_DATE}): Fixed Windows compatibility and styling issues
